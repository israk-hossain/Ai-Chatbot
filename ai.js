...
// API Setup
const API_KEY = "AIzaSyD-lE-cktkiSDEat9FQWvR3WlVl6MC2B8o";
const API_URL = `https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${API_KEY}`;

// Sound files
const messageSendSound = new Audio('path/to/message-send.mp3'); // Replace with the correct path
const buttonClickSound = new Audio('path/to/button-click.mp3'); // Replace with the correct path
...
// Toggle dark/light theme and play sound
